...
Public Class APP_HANADb
    Public DotNet As App_DotNet
    Private oSqlConnection As HanaConnection, oSqlDataAdapter As HanaDataAdapter, oSqlCommand As HanaCommand, oSqlTransaction As HanaTransaction
    ...
    Private Sub DbQuery()
        Try
            ...
            Using oCon = New HanaConnection("Server=" & _SqlServer & "; UserID=" & _SqlId & "; Password=" & _SqlPassword & "; databaseName=" & _SqlDb & "")
                Using oCommand = New HanaCommand(_strCommand, oCon)
                    oCommand.CommandTimeout = 0
                    Using oDa = New HanaDataAdapter(oCommand)
                        oDa.Fill(Ds)
                    End Using
                End Using
            End Using
        ...
        Catch ex As Exception
            oWriteText(MainForm.LsView, ex.ToString, Color.Red)
